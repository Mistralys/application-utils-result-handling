 ...
 * all {@see self::makeError()} and {@see makeSuccess()} calls
 * as separate error or success instances. Adding a collection to
 * a collection will make it inherit all results the target
 * collection contains.
 *
 * @package Application Utils
 * @subpackage OperationResult
